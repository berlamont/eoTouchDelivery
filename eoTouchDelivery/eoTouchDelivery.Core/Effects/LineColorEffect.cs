...
namespace eoTouchDelivery.Core.Effects
{
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("eoTouchDelivery.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("eoTouchDelivery.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("eoTouchDelivery.PickerLineColorEffect")
            {
            }
        }
    }
